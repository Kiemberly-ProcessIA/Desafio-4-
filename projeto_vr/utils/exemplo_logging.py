...
from utils.logging_config import (LoggerContextManager, get_logger,
                                  log_erro_critico, log_fim_passo,
                                  log_inicio_passo, log_processamento,
                                  log_resultado_validacao, log_step)
...
def exemplo_logs_padronizados():
    ...
    log_fim_passo(
        "PASSO EXEMPLO", "Demonstração do Sistema de Logging", estatisticas, logger
    )
