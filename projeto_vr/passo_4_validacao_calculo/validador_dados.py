...
class ValidadorDados:
    ...
    def __init__(self, config_path: str = None):
        ...
        self.campos_obrigatorios = [
            'matricula', 'empresa', 'cargo', 'situacao', 
            'sindicato', 'status'
        ]
    ...
    def validar_base_completa(self, dados_json: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info(f"Validação concluída. {corrigidos}/{total_colaboradores} colaboradores corrigidos")
        return dados_validados
    
    def _validar_campos_obrigatorios(self, colaborador: Dict[str, Any], matricula: str) -> Dict[str, Any]:
    ...
    def _validar_corrigir_datas(self, colaborador: Dict[str, Any], matricula: str) -> Dict[str, Any]:
    ...
    def _validar_ferias(self, colaborador: Dict[str, Any], matricula: str) -> Dict[str, Any]:
            ...
            if dias_ferias is not None:
                try:
                    ...
                    if dias_ferias_int < 0 or dias_ferias_int > 30:
                        colaborador['ferias']['dias_ferias'] = min(max(dias_ferias_int, 0), 30)
                        self.relatorio_validacao.append({
    ...
    def _validar_sindicato(self, colaborador: Dict[str, Any], matricula: str) -> Dict[str, Any]:
        ...
        if sindicato:
            for sigla, nome_completo in mapeamento_sindicatos.items():
                if sigla.lower() in sindicato.lower() or nome_completo.lower() in sindicato.lower():
    ...
    def gerar_relatorio_validacao(self, arquivo_saida: str = "relatorio_validacao.txt"):
        ...
        with open(arquivo_saida, 'w', encoding='utf-8') as f:
            ...
            f.write(f"Total de problemas encontrados: {len(self.relatorio_validacao)}\n\n")
...
def executar_validacao(arquivo_entrada: str, arquivo_saida: str = None) -> Dict[str, Any]:
    """
...
if __name__ == "__main__":
    ...
    print(f"Validação concluída. {len(dados_validados.get('colaboradores', {}))} colaboradores processados.")
